    ...
    },
    {
      ...
      events: [
        ...
        },
        {
          ...
          location: "博多站商圈",
          area: "Fukuoka",
          description: "逛博多丸井、博多阪急、AMU PLAZA 與車站周邊商店。",
          transport: "博多站 → 博多丸井 → 博多阪急 → AMU PLAZA",
          notes: "優先安排 Godzilla Store Hakata（博多丸井 2F）與 Sanrio（博多阪急 7F）；17:15 左右收尾。",
